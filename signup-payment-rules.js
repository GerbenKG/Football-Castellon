(() => {
  ...
  function applyDashboard(data) {
    ...
    // Game squad: signup is the commitment. There is no Present control here.
  ...
  function applyFinance(data) {
    ...
    const values = [seasonIncome + paidGameIncome - paidExpenses, outstanding, null, null];
    ...
    if (dueTable) {
      ...
      if (tbody) {
        ...
        tbody.innerHTML = rowsHtml || '<tr><td colspan="4" class="empty">Nothing outstanding.</td></tr>';
      }
    }
  }
